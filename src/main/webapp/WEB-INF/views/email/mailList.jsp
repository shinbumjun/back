...
<html>
	...
	<form action="" method="get" style="width:100%;display: flex; justify-content: space-between;">
		<div id="selectBox" style="width: 290px; padding-top: 50px;">
			<input type="button" class="mail_toolbar" id="SelectAll" value="전체선택" style="font-weight: 700; margin-right: 10px;">
			<input type="radio" id="All_Read" value="all" name="readCon"  style="display: inline-block; vertical-align: middle;"><label for="female" >전체</label>
			<input type="radio" id="Read" value="read" name="readCon" style="display: inline-block; vertical-align: middle;"><label for="read">읽음</label>
